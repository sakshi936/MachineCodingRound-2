...
function RandomUser() {
	...
	return (
		<div className="bg-[url('/Random-User/bg1.svg')] w-full h-full  py-8 flex justify-center items-center text-black">
			{/* profile card */}
			<div className="w-[360px] h-[610px] bg-[#B6B3F3] rounded-xl border-[8px] border-white p-4 flex flex-col justify-between">
				{/* profile Overview */}
				<section>
